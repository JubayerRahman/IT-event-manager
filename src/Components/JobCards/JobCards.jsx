    ...
    <div data-aos="flip-left" className='mx-[20px] '>
      <div className="card card-compact flex  bg-base-100 shadow-xl p-[20px] lg:h-[400px]">
        <div className="card-body">
            <h2 className="card-title specialFont">Job title: {job_position}</h2>
            <div data-aos="fade-right" className='w-[70vw] md:w-1/3 rounded-lg h-[6px] bg-[#A937D4] my-[10px]'></div>
            <p> <span className='text-[16px]  font-bold specialFont'>Description:</span>  {job_description}</p>
            <p> <span className='text-[16px]  font-bold specialFont'>Requirements:</span>  {job_requirements}</p>
            <p> <span className='text-[16px]  font-bold specialFont'>Education:</span>  {education_requirements}</p>
            <p> <span className='text-[16px]  font-bold specialFont'>Experience:</span>  {experience}</p>
